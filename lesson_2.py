...
#     def init(self, company, capacity, max_speed, model, year):
...
# class Car(Transport):
#      def init(self, company, capacity, max_speed, model, year, wheels = 4):
#         Transport.init(self, company, capacity, max_speed, model, year)
#         self.wheels = wheels
#         self.penalties = 0
...
#     def init(self, company, capacity, max_speed, model, year):
#       super().init(company, capacity, max_speed, model, year)
...
# class Dog(Animal):
#     def init(self, name, color, breed):
#         Animal.init(self, name, color)
#         self.breed = breed
